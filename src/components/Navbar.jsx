...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/70 bg-slate-50/90 backdrop-blur-xl transition-colors duration-500 dark:border-slate-800 dark:bg-slate-950/90">
      ...
      {open && (
        <div className="border-t border-white/70 px-4 pb-4 dark:border-slate-800 lg:hidden">
          <div className="mx-auto flex max-w-7xl flex-col gap-2 rounded-3xl bg-slate-100/80 p-3 shadow-neo dark:bg-slate-900 dark:shadow-dark-neo">
